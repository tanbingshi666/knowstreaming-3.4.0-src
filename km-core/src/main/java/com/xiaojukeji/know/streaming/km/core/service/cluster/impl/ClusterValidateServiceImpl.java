...
public class ClusterValidateServiceImpl implements ClusterValidateService {
    ...
    public Result<KafkaValidate> checkKafkaLegal(String bootstrapServers, Properties clientProps, String zookeeper) {
        ...
        // 检查BS
        /**
         * 直接创建 KafkaConsumer 查询 __consumer_offsets 分区个数
         * 如果发生异常 说明 Kafka BootstrapServer 地址错误
         */
        ...
        // BS合法，需要尝试获取其他信息
        /**
         * 1 根据 Kafka BootstrapServer 地址去连接 Kafka 获取 Zookeeper Address
         * 2 根据 Zookeeper Address 获取 brokers/ids 第一个 Znode Broker 信息 (host、jmx_port)
         * 3 根据 (host、jmx_port) 连接 Kafka JMX 服务获取 Kafka 版本
         */
